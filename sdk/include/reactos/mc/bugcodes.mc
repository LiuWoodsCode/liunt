...
Language=English
A fatal error has been detected and LiuNT has halted your CPU to prevent damage
to your data.
.
...
for any LiuNT updates you might need.
...
Language=English
A system file that is owned by LiuNT was replaced by an application
...
has prevented LiuNT from operating.  You can determine which component is
...
hardware problem thereby allowing LiuNT to operate.
.
...
Language=English
The user manually generated the crash dump using a debugger.
.
