...
{
    {
        4,
        3,
        " LiuNT " KERNEL_VERSION_STR " Setup ",
    ...
    },
    {
        0,
        20,
        "Please wait while the LiuNT Setup initializes itself",
...
static MUI_ENTRY enUSWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "This part of the setup copies the LiuNT Operating System to your",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Press ENTER to install or upgrade LiuNT.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Press R to repair a LiuNT installation using the Recovery Console.",
        "\x07  Press R to repair a ReactOS or LiuNT installation.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Press L to view the LiuNT Licensing Terms and Conditions.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Press F3 to quit without installing LiuNT.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "For more information on LiuNT, please visit:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "LiuNT is in Alpha stage, meaning it is not feature-complete",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "\x07  Press ENTER to continue LiuNT Setup.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "The LiuNT System is licensed under the terms of the",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "All software that is part of the LiuNT system is",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "LiuNT only covers distribution to third parties.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License with LiuNT please visit",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "LiuNT Setup is in an early development phase. It does not yet",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "The LiuNT Setup can upgrade one of the available ReactOS or LiuNT installations",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "listed below, or, if a LiuNT installation is damaged, the Setup program",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "LiuNT is not completely installed.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "The basic components of LiuNT have been installed successfully.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Press ENTER to install LiuNT onto the selected partition.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "uses a format not supported by LiuNT.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "In order to successfully install LiuNT, the Setup program must change",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "to the original one after finishing the installation of LiuNT.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "programs, programs to start an operating system (like AbsoluteSolver) or other",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "computer from the harddisk until you finished the LiuNT Setup.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installs LiuNT files onto the selected partition. Choose a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "directory where you want LiuNT to be installed:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "characters and then type the directory where you want LiuNT to",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Please wait while LiuNT Setup copies files to your LiuNT",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY enUSPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup prepares your computer for copying the LiuNT files.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR enUSErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "LiuNT is not completely installed on your\n"
        "computer. If you quit Setup now, you will need to\n"
        "run Setup again to install LiuNT.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Failed to build the installation paths for the LiuNT installation directory!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "You cannot install LiuNT within the installation source directory!\n"
        "ENTER = Reboot computer"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "The selected partition is not large enough to install LiuNT.\n"
...
MUI_STRING enUSStrings[] =
{
    ...
    "You chose to install LiuNT on a new or unformatted Partition."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "The system partition is not formatted yet."},
    {STRING_NONFORMATTEDOTHERPART,
    "The new partition is not formatted yet."},
    {STRING_INSTALLONPART,
    "Setup installs LiuNT onto Partition"},
    {STRING_CONTINUE,
    "ENTER = Continue"},
    {STRING_QUITCONTINUE,
    "F3 = Quit  ENTER = Continue"},
